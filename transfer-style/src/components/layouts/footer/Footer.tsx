...
export function Footer() {
    ...
    return ( 
      ...
      <div className="flex flex-col md:flex-row justify-between flex-wrap gap-[16px] divide-y-2 md:divide-y-0 mb-[70px]">
        ...
        <Logo/>
          ...
          <div className="flex items-start gap-2.5 mt-2 lg:mt-3">
            ...
            <div className="font-lato text-medium text-blue-300"><span className="font-bold">Call Us:</span> (+91) - 540-025-124553</div>
                ...
                <div className="flex items-start gap-2.5 mt-2 lg:mt-3">
                <IconBox icon={"icon-paper-plane  text-[24px] text-brand1"} />

            <div className="font-lato text-medium text-blue-300"><span className="font-bold">Email:</span> contact@nestmart.com</div>
          </div>
                <div className="flex items-start gap-2.5 mt-2 lg:mt-3">
                <IconBox icon={"icon-time-fast  text-brand11"} />
        
            <div className="font-lato text-medium text-blue-300"><span className="font-bold">Hours:</span> 10:00 - 18:00, Mon - Sat</div>
          </div>
        </div>
        <div className="pt-4 md:pt-0">
                    <div className="flex font-quickSand text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading4 text-blue-300 toggle">Company
                        <IconBox icon={"icon-down-dark  text-[24px] inline-block sm:hidden"}  size={24} /> </div>
        ...
        <div className="pt-4 md:pt-0">
                        <div className="flex font-quickSand text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading4 text-blue-300 toggle">Information
                            <IconBox icon={"icon-down-dark  text-[24px] inline-block sm:hidden"}  size={24} />
        ...
        <div className="pt-4 md:pt-0">
          <div className="font-quickSand text-heading6 md:text-heading5 lg:text-heading4 xl:text-heading4 text-blue-300">App & Payment</div>
