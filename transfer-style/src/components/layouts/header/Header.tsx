      ...
      <div className="container flex items-center justify-between py-4 md:py-6 xl:py-8">
                ...
                <ul className="hidden lg:flex gap-5">
                    <li className="flex gap-2 cursor-pointer">
                        <IconBox linkClassName={"flex items-center gap-x-1"} icon={"icon-user"} size={24} title={"Account"} HideTitleOnMobile={true} link={'#'} titleClassName={"text-medium text-gray-500 font-lato"} />                     
                    </li>
                    <li className="flex gap-2 cursor-pointer">
                         <IconBox  linkClassName={"flex items-center gap-x-1"} icon={"icon-shopping-cart"} size={24} title={"Card"} HideTitleOnMobile={true} link={'#'}  badge={4} titleClassName={"text-medium text-gray-500 font-lato"}/>                    
                   </li>
                </ul>
